...
$.extend(Datepicker.prototype, {
	...
	_doKeyDown: function(event) {
		...
		if ($.datepicker._datepickerShowing) {
			switch (event.keyCode) {
				...
				case 36: if (event.ctrlKey || event.metaKey) {
						...
						handled = event.ctrlKey || event.metaKey;
						break; // current on ctrl or command +homes
		...
		} else if (event.keyCode === 36 && event.ctrlKey) { // display the date picker on ctrl+homes
...
/*!
 * Generated using the Bootstrap Customizer (http://getbootstrap.com/customize/?id=629317e4ef7cf60d8516)
 * Config saved to config.json and https://gist.github.com/629317e4ef7cf60d8516
 */
...
function create_comments(){
  ...
  $('.reply_send_comment').click(function(){
    ...
    var comments = $('.reply_comment_message_'+parent_id).val();
